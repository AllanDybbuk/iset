...
;(function () {
  ...
  window.__ISET__ = {
    ...
    empresa: {
      ...
      fundacion:   '2018',
      descripcion: 'Desde 2018, ISET proyecta e instala infraestructura eléctrica, redes certificadas y sistemas de seguridad para empresas, industrias y proyectos de alto estándar en todo Chile. Cada trabajo está respaldado por ingeniería rigurosa, certificaciones vigentes y un equipo que no deja cabos sueltos.'
    },
    ...
    servicios: [
      ...
      {
      id:     'montajes',
      titulo: 'Montajes Eléctricos',
      icono:  'montajes',
      desc:   'Ensamblaje, canalización y anclaje de tableros eléctricos, gabinetes y salas de control. Garantizamos instalaciones ordenadas, robustas y bajo estricta normativa SEC.',
      tags:   ['Tableros Eléctricos', 'Canalización', 'Gabinetes / Racks', 'Fuerza y Control']
      }
    ],
